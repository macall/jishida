...
//页面跳转同步通知页面路径
$call_back_url = SITE_DOMAIN.APP_ROOT."/call_back_url.php?from=".$_REQUEST['from'];
...
$html_text = $alipaySubmit->alipay_gateway_new.$alipaySubmit->buildRequestParaToString($parameter);
?>

<script type="text/javascript" src="ap.js"></script>
<script>
_AP.pay('<?php echo $html_text; ?>');
</script>
