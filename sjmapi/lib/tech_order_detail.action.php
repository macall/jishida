...
class tech_order_detail{
	public function index()
	{
		...
		if($user_id>0)
		{
			...
			" where o.is_delete = 0 and o.technician_id = {$user_id} and o.id = {$order_id} limit 1";
...
//				$deliveryAddr['delivery'] = $order_info['r1_name'].$order_info['r2_name'].$order_info['r3_name'].$order_info['r4_name'];
                                $deliveryAddr['delivery'] = $order_info['r2_name'].$order_info['r3_name'].$order_info['r4_name'];
				...
				$root['service_start_time'] = $order_info['service_start_time'];//服务开始时间
				$root['service_time'] = $order_info['service_time'];//服务开始时间
				$root['order_time'] = $order_info['order_time']==0?'':date("Y-m-d H:i:s",$order_info['order_time']);//服务开始时间
				$root['remain_time'] = $order_info['service_start_time']+$order_info['service_time']*60-time();//服务开始时间
