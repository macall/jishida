...
class Walipay_payment implements payment {
	...
	public function get_payment_code($payment_notice_id)
	{
		...
		//$notify_url = SITE_DOMAIN.APP_ROOT.'/index.php?ctl=payment&act=notify&class_name=Walipay';
		$notify_url = SITE_DOMAIN.APP_ROOT.'/alipay_web/alipayapi.php?order_id='.$payment_notice['order_id']."&from=".$GLOBALS['request']['from'];
		$pay = array();
		$pay['subject'] = $subject;
		$pay['body'] = $title_name;
		$pay['total_fee'] = $money;
