...
(function (a, b, c) {
    ...
    function j(a, b, c, d) {
        ...
        l = k && '-' + k + '-' || '';
        e[g] || (i.insertRule('@' + l + 'keyframes ' + g + '{' + '0%{opacity:' + j + '}' + h + '%{opacity:' + a + '}' + (h + 0.01) + '%{opacity:1}' + (h + b) % 100 + '%{opacity:' + a + '}' + '100%{opacity:' + j + '}' + '}', 0), e[g] = 1);
        return g
    }
    function h(a, b, c) {
        ...
        spin: function (a) {
            ...
            if (!f) {
                ...
                (function q() {
                    ...
                    b.timeout = b.el && setTimeout(q, ~~(1000 / k))
                }) ()
            }
            return b
        },
    ...
    function () {
        ...
        if (!k(a, 'transform') && a.adj) {
            for (b = 4; b--; ) i.addRule(['group',
            'roundrect',
            'fill',
            'stroke'][b], 'behavior:url(#default#VML)');
            q.lines = function (a, b) {
                function k(a, d, i) {
                    h(f, h(l(e(), {
